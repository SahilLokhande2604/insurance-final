    ...
    <nav className="bg-white border-b sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden lg:flex items-center gap-6 font-medium">
            ...
            {user && <Link to="/my-policies">My Policies</Link>}
          ...
          <div className="flex items-center gap-12">
            ...
            {!user && (
              <div className="hidden md:flex gap-2">
                <Link
                  to="/login"
                  className="px-4 py-2 text-sm font-medium text-[#1A73E8] border border-[#1A73E8] rounded-lg hover:bg-[#1A73E8]/10"
                >
                  Login
                </Link>
                <Link
                  to="/register"
                  className="px-4 py-2 text-sm font-medium text-white bg-[#1A73E8] rounded-lg hover:bg-[#1A73E8]/90"
                >
                  Register
                </Link>
              </div>
      ...
      {mobileMenuOpen && (
        <div className="md:hidden bg-white border-t px-4 py-4 space-y-3 font-medium">
          ...
          <Link to="/policies" onClick={() => setMobileMenuOpen(false)}>Policies</Link>

          {user && <Link to="/my-policies" onClick={() => setMobileMenuOpen(false)}>My Policies</Link>}
          {user && <Link to="/claims" onClick={() => setMobileMenuOpen(false)}>Claims</Link>}
          ...
          {!user && (
            <div className="pt-3 flex gap-2">
              <Link to="/login" className="w-full text-center border py-2 rounded">
                Login
              </Link>
              <Link to="/register" className="w-full text-center bg-[#1A73E8] text-white py-2 rounded">
                Register
              </Link>
            </div>
          )}
